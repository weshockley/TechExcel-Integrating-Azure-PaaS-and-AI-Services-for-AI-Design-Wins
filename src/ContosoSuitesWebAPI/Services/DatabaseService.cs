...
public class DatabaseService : IDatabaseService
{
    ...
    [KernelFunction]
    [Description("Get all bookings for a single hotel.")]
public async Task<IEnumerable<Booking>> GetBookingsMissingHotelRooms([Description("The ID of the hotel")] int hotelId)
    {
        var sql = """
            SELECT
                b.BookingID,
    ...
    [KernelFunction]
    [Description("Get all bookings for a single hotel.")]
public async Task<IEnumerable<Booking>> GetBookingsWithMultipleHotelRooms([Description("The ID of the hotel")] int hotelId)
    {
        var sql = """
            SELECT
                b.BookingID,
